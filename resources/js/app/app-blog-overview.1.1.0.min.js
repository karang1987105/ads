...
!function (e) {
    e(document).ready(function () {
            ...
            var a = {
                ...
                scales: {
                    ...
                    yAxes: [{
                        gridLines: !1,
                        scaleLabel: !1,
                        ticks: {display: !1, suggestedMax: Math.max.apply(Math, e.data) + 1}
                    }]
                }
        ...
        var o = document.getElementsByClassName("blog-overview-users")[0], a = {
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        ...
                        ticks: {
                            suggestedMax: 45, callback: function (e, o, a) {
